...
- *"Neural network approach for a rapid prediction of metal-supported borophene properties"*, P. Mignon, A. Allouche, N.R. Innis, and C. Bousige, [*J. Am. Chem. Soc.* **145** (2023), 27857-27866](https://doi.org/10.1021/jacs.3c11549) <details> <summary>bibtex</summary>
