...
vasp_dir = "/softs/CompChemPackages/VASP6/Gnu"
# Path to scratch directory on the cluster
clusterwdir = "/scratch/$USER/vasp"
# Where to find the active_learning scripts and convert-VASP_OUTCAR_AU.py from n2p2
mybin = "$HOME/Boro_ML/bin"
# Path where n2p2 is installed
n2p2_dir = "$HOME/bin/n2p2"
# Patth to OpenMPI environment
openmpi_env = "$HOME/bin/openmpi401/openmpi4.sh"
# Path to GSL environment
