...
def getArguments():
    ...
    parser.add_argument("--request", type=str, default='init', help='--request=init (default), ScalTrainPred, CompEfSSDFT, DFT_vasp : action requested to the active learning')
    parser.add_argument("--stepNB", type=str, default='0', help='--stepNB=0 (default) active learning step number, used to name the output files')
    parser.add_argument("--nnodes", type=int, default='2', help='--nnodes=2 (default) nb of nodes used for this job')
    parser.add_argument("--minimize", type=str, default="energy", help="--minimize=energy (default), forces : the quantity to compare between NNPs during the active")
